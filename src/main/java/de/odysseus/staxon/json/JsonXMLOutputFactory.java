...
public class JsonXMLOutputFactory extends XMLOutputFactory {
	...
	public XMLStreamWriter createXMLStreamWriter(Writer stream) throws XMLStreamException {
		return JsonXMLStreamUtil.createJsonXMLStreamWriter(stream, true);
	}
	...
	public XMLStreamWriter createXMLStreamWriter(OutputStream stream, String encoding) throws XMLStreamException {
		try {
			return JsonXMLStreamUtil.createJsonXMLStreamWriter(new OutputStreamWriter(stream, encoding), true);
